...
import com.saniou.santieba.model.bean.FollowList
import com.saniou.santieba.model.bean.FollowResponse
import com.saniou.santieba.model.bean.Follows
import com.saniou.santieba.model.bean.ForumPage
import com.saniou.santieba.model.bean.ForumRecommend
import com.saniou.santieba.model.bean.ForumSug
import com.saniou.santieba.model.bean.GetForumList
import com.saniou.santieba.model.bean.LikedForum
import com.saniou.santieba.model.bean.Msign
import com.saniou.santieba.model.bean.Profile
import com.saniou.santieba.model.bean.SearchPost
import com.saniou.santieba.model.bean.Sign
...
import com.saniou.santieba.model.bean.UserPost
...
object TiebaRequest : TiebaService {
    ...
    suspend fun threadstore(offset: Int): ThreadStore {
        val hashMap = HashMap<String, String>()
        hashMap["BDUSS"] = this.BDUSS
        hashMap["_client_id"] = this.clientId
        hashMap["_client_type"] = this.clientType
                ...
                Request.Builder()
                    .post(
                        MultipartBody.Builder().setType(MultipartBody.FORM).addPart(
                            headersOf("Content-Disposition", "form-data; name=BDUSS"),
                    ...
                    .url("http://c.tieba.baidu.com/c/c/img/upload").headers(headers.toHeaders())
                    .build()
            )
            .execute()
            .body

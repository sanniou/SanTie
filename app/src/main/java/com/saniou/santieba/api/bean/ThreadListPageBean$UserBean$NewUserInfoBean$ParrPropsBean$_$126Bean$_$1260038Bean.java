...
public class ThreadListPageBean$UserBean$NewUserInfoBean$ParrPropsBean$_$126Bean$_$1260038Bean {
    ...
    public static ThreadListPageBean$UserBean$NewUserInfoBean$ParrPropsBean$_$126Bean$_$1260038Bean objectFromData(
            String str) {
        return (ThreadListPageBean$UserBean$NewUserInfoBean$ParrPropsBean$_$126Bean$_$1260038Bean) new Gson()
                .fromJson(str,
                        ThreadListPageBean$UserBean$NewUserInfoBean$ParrPropsBean$_$126Bean$_$1260038Bean.class);
    }

    public static List<ThreadListPageBean$UserBean$NewUserInfoBean$ParrPropsBean$_$126Bean$_$1260038Bean> array_$1260038BeanFromData(
            String str) {
        return (List) new Gson().fromJson(str,
                new TypeToken<ArrayList<ThreadListPageBean$UserBean$NewUserInfoBean$ParrPropsBean$_$126Bean$_$1260038Bean>>() {
                }.getType());
    }
